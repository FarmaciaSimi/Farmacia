<?php
	...
	if($datos_venta->rowCount()==1){
		...
		require "./code128.php";
		$pdf = new PDF_Code128('P','mm',array(100,258));//tamaño
        ...
        $pdf->Image(APP_URL.'app/views/img/logo2.png',75,5,20,20,'PNG'); //---------------LOGO DE LA EMPRESA O NEGOCIO-----------
        ...
        $pdf->SetFont('Arial','B',10);
        $pdf->MultiCell(0,5,iconv("UTF-8", "ISO-8859-1",strtoupper("Num Ticket: ".$datos_venta['venta_id'])),0,'C',false);
        $pdf->SetFont('Arial','',9);
        ...
        $pdf->Cell(15,5,iconv("UTF-8", "ISO-8859-1","Produc."),0,0,'C');
        ...
        foreach($venta_detalle as $detalle){
            ...
            $pdf->Image(APP_URL.'app/views/productos/acetazolamida.jpg',80,68,7,7,'JPG');//---IMAGEN DEL PRODUCTO, POSICION, TAMAÑO, TIPO
            $pdf->Image(APP_URL.'app/views/productos/algodon.jpg',80,78,7,7,'JPG');
            $pdf->Image(APP_URL.'app/views/productos/melena_de_leon.jpg',80,88,7,7,'JPG');
            //$pdf->Cell(18,4,iconv("UTF-8", "ISO-8859-1",$detalle['venta_detalle_cantidad']),0,0,'C');
            $pdf->Ln(4);
            $pdf->Ln(3);
        }
        ...
        $pdf->Code128(15,$pdf->GetY(),$datos_venta['venta_codigo'],70,20);
        $pdf->SetXY(5,$pdf->GetY()+21);
        $pdf->SetFont('Arial','',14);
        $pdf->MultiCell(0,8,iconv("UTF-8", "ISO-8859-1",$datos_venta['venta_codigo']),0,'C',false);
