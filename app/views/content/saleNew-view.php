...
/*try {
    ...
    $mail->Username   = 'aldairramon61@gmail.com';                     //SMTP username
    $mail->Password   = 'lttlxavnljzsiuch';                               //SMTP password
    //$mail->Username   = 'lert.07.04.95@gmail.com';                     //SMTP username
    //$mail->Password   = 'vwaovqzzszyejjtv';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('aldairramon61@gmail.com', 'Farmacia');
    //$mail->setFrom('lert.07.04.95@gmail.com', 'CODEPE');
    $mail->addAddress('aldairramon41@gmail.com', 'Farmacia');     //Add a recipient
    //$mail->addAddress('pruebacorreocode@gmail.com', 'CODEPE');     //Add a recipient

    $mail->addAttachment('C:/xampp/htdocs/ESLAVA/VENTAS-Aldair/app/views/productos/algodon.jpg', 'new.jpg');
    //$mail->addAttachment('img/profile_3135715.png', 'new.png');
...
<div class="container pb-6 pt-6">
    <div>
        <h4>Ingrese el correa para enviar el ticket= 
            <input value="aldairramon41@gmail.com"  type="email" name="email" style="max-width: 350px;">
        </h4>
        </div>
    <?php
                            ...
                            <button type="button" class="button is-link is-light" onclick="print_invoice('<?php echo APP_URL."app/pdf/invoice.php?code=".$_SESSION['venta_codigo_factura']; ?>')" >
                                ...
                                <?php 
                                    try {
                                        ...
                                        $mail->SMTPAuth   = true;                                   //Enable SMTP authentication
                                        $mail->Username   = 'aldairramon61@gmail.com';                     //SMTP username
                                        //$desdEmail        = $_REQUEST["email"];                             //SMTP password
                                        $desdEmail        = 'aldairramon41@gmail.com';                             //SMTP password
                                        $mail->Password   = 'lttlxavnljzsiuch';                               //SMTP password
                                        //$mail->Username   = 'lert.07.04.95@gmail.com';                     //SMTP username
                                        //$mail->Password   = 'vwaovqzzszyejjtv';                               //SMTP password
                                        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
                                        ...
                                        $mail->setFrom('aldairramon61@gmail.com', 'Farmacia');
                                        //$mail->setFrom('lert.07.04.95@gmail.com', 'CODEPE');
                                        $mail->addAddress($desdEmail, 'Farmacia');     //Add a recipient
                                        //$mail->addAddress('pruebacorreocode@gmail.com', 'CODEPE');     //Add a recipient

                                        //$mail->addAttachment(APP_URL."app/pdf/ticket.php?code=".$_SESSION['venta_codigo_factura'], 'new.pdf');
                                        $mail->addAttachment('C:/xampp/htdocs/ESLAVA/VENTAS-Aldair/app/views/productos/Ticket_Nro40.pdf', 'Ticket 14/05/2024.pdf');
                                        //$mail->addAttachment('C:/xampp/htdocs/ESLAVA/VENTAS-Aldair/app/views/productos/algodon.jpg', 'new.jpg');
                                        //$mail->addAttachment(Output("I","Ticket_Nro".$datos_venta['venta_id'].".pdf",true));
                                        //$mail->addAttachment('img/profile_3135715.png', 'new.png');
                ...
                <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
                    ...
                    <tbody>
                        ...
                        <tr class="has-text-centered" >
                            ...
                            <td>
                                <div class="control">
                                    <input class="input sale_input-cant has-text-centered" value="<?php echo $productos['venta_detalle_cantidad']; ?>" id="sale_input_<?php echo str_replace(" ", "_", $productos['producto_codigo']); ?>" type="number" style="max-width: 50px;">
