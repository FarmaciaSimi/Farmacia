				...
				function drawChart() {
					var data = google.visualization.arrayToDataTable([
						...
						while ($detalle = mysqli_fetch_assoc($consulta)) {
							echo "['" . $detalle['venta_detalle_descripcion'] . " " . $detalle['venta_detalle_cantidad'] . "pzs." . "', " . $detalle['venta_detalle_cantidad'] . "],";
						}
						//$SQL = "SELECT * FROM venta_detalle";
						//$consulta = mysqli_query($conexion, $SQL);
						//while ($resultado = mysqli_fetch_assoc($consulta)) {
						//while ($resultado = mysqli_fetch_assoc($consulta)) {
							//echo "['" . $resultado['venta_codigo'] . " " . $resultado['venta_detalle_cantidad'] . "pzs." . "', " . $resultado['venta_detalle_cantidad'] . "],";
						//	echo "['" . $resultado['venta_detalle_descripcion'] . " " . $resultado['venta_detalle_cantidad'] . "pzs." . "', " . $resultado['venta_detalle_cantidad'] . "],";
						//}
						?>
					]);
					var options = {
